...
<!--                </li>-->
                <li class="page-item">
                    <a class="page-link" href=<?php echo "/index.php?query_type=$query_type&type=$type&pokemon_per_page=$pokemon_per_page&results_page=$current_results_page_string_minus_one" ?>>Next</a>
                </li>
                <?php
            }
            ?>
...
<!--                </li>-->
                <li class="page-item">
                    <a class="page-link" href=<?php echo "/index.php?query_type=$query_type&type=$type&pokemon_per_page=$pokemon_per_page&results_page=$current_results_page_string_plus_one" ?>>Next</a>
                </li>
                                                             <?php
          //   }
            ?>
